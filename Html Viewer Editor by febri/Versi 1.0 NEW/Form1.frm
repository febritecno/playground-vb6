...
Begin VB.Form Form1 
   ...
   Begin VB.Menu file 
      ...
      Begin VB.Menu space0 
         Caption         =   "-"
      End
      Begin VB.Menu Kembali 
         Caption         =   "Kembali"
         Checked         =   -1  'True
      End
      Begin VB.Menu selanjutnya 
         Caption         =   "Selanjutnya"
      End
   ...
   Begin VB.Menu insert 
      ...
      Begin VB.Menu font 
         ...
         End
         Begin VB.Menu Book 
            Caption         =   "Book Antiqua"
         End
         Begin VB.Menu Calibri 
            Caption         =   "Calibri"
         End
         Begin VB.Menu Cooper 
            Caption         =   "Cooper"
         End
         Begin VB.Menu Trebuched 
            Caption         =   "Trebuched MS"
         End
      End
...
RichTextBox1.font = "Book Antiqua"
End Sub
...
RichTextBox1.font = "Calibri"
End Sub

Private Sub Cooper_Click()
...
Exit Sub
errorback:
MsgBox "Tidak Ada Halaman Sebelumnya!", vbInformation
End Sub
...
RichTextBox1.SelText = "<b>a</b>"
End Sub

Private Sub Trebuched_Click()
RichTextBox1.font = "Trebuched MS"
End Sub
